...
- `models.py`: Pydantic models for `DataContract`, `DatasetContract`, `ColumnContract`, `RuleTemplate`, `RuleBinding`, lifecycle metadata, plus references to schema/rule/infra/governance libraries and catalog mappings.
